...
- See [protein-language-models](../concepts/protein-language-models.md), [cofolding-models](../concepts/cofolding-models.md) for model-family detail. Virtual cell models: [evo-2](../entities/evo-2.md), STATE, [alphafold-3](../entities/alphafold-3.md) (cofolding flagship), AlphaGenome, GPN-Star.
...
- See [medical-imaging-ai](../concepts/medical-imaging-ai.md) for full imaging-by-specialty treatment.
...
- LLM clinical reasoning: see [llm-clinical-reasoning](../concepts/llm-clinical-reasoning.md) for Brodeur et al. NEJM data.
- AI agents in clinical medicine: see [agentic-clinical-ai](../concepts/agentic-clinical-ai.md); key entity [mai-dxo](../entities/mai-dxo.md).
- FDA pathway and device counts: see [fda-510k-pathway](../concepts/fda-510k-pathway.md).
...
- Enterprise deployments: see [ambient-ai-scribes](../concepts/ambient-ai-scribes.md) (key entity [abridge](../entities/abridge.md)); sepsis prediction ([trews](../entities/trews.md), COMPOSER).
- Generative AI in EHRs: ChatEHR (Stanford, 23,000 sessions, 1,075 trained users), OpenEvidence (40% U.S. physician adoption).
- Evidence gaps and governance: [arise-network](../entities/arise-network.md) (Stanford-Harvard, *State of Clinical AI Report* Jan 2026), NOHARM benchmark, Stanford Health Care's FURM framework, GUIDE-AI Lab. See [clinical-validation](../concepts/clinical-validation.md).
- Digital twins: see [digital-twins-medicine](../concepts/digital-twins-medicine.md); 12.1% of 149 studies satisfied NASEM definition; Twin Health diabetes RCT (n=150, 71% achieved HbA1c <6.5%).
