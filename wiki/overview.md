...
## State of the field as of early 2026 (per [[ai-index-2026]])
...
- **[[clinical-validation]]** — the central tension. ARISE 5%/half-study finding. Prospective trials growing 28.5% YoY but still small relative to publication volume.
- **[[arise-network]]** — meta-evaluator publishing the *State of Clinical AI Report*.
- **[[fda-510k-pathway]]** — the regulatory substrate; substantial-equivalence-not-RCT model; 1,357 cumulative cleared devices.

### 2. The diagnostic-modality axis
- **[[medical-imaging-ai]]** — 76.6% of cleared devices, but data ~100x smaller than general; cross-model benchmarking still weak.
- Specialty depth in [[medical-imaging-ai]]: cardiology, oncology, ophthalmology, pathology, radiology each have their own model & FDA-cleared product lineup.

### 3. The reasoning / agentic axis
- **[[llm-clinical-reasoning]]** — single-LLM benchmark performance now exceeds physician case-bench scores (o1-preview NEJM Healer: 78/80 vs. attendings 28/80; management reasoning 86% vs. 34%).
- **[[agentic-clinical-ai]]** — multi-agent systems gain 7–60% over single-agent baselines.
- **[[mai-dxo]]** — flagship: 85.5% on NEJM cases vs. ~20% for 21 experienced physicians.
- All gated by the case-bench-vs-real-practice translation problem.

### 4. The deployed-clinical-AI axis
- **[[ambient-ai-scribes]]** — biggest 2025 deployment story; **[[abridge]]** at 150+ health systems.
- **[[trews]]** — sepsis early warning, 18.7% mortality reduction, 13 Cleveland Clinic hospitals.
- These are the case studies for the *strong evidence track*.

### 5. The biomedical-foundation-model axis
- **[[protein-language-models]]** — 2025 shift from scaling (ESM3, 98B) to specialization (MSAPairformer, 111M, beats SOTA).
- **[[cofolding-models]]** — [[alphafold-3]] still leads FoldBench at 64.9%; data, not scale, is the bottleneck.
- **[[evo-2]]** — 40B-parameter genomic FM; outperformed by 200M GPN-Star on variant effect prediction. "Scale alone isn't sufficient."
...
- **[[digital-twins-medicine]]** — large publication/patent growth; only 12.1% of studies meet NASEM definition; Twin Health diabetes RCT (n=150) is the strongest result.
