...
Together, TREWS and COMPOSER are evidence that **clinician-in-the-loop EWS systems can produce real-world mortality improvements** — distinct from the case-bench-only validation that dominates other clinical AI categories. See [[clinical-validation]] for the broader context.
...
The AI Index frames TREWS, COMPOSER, and ambient scribes as exemplars of **narrow tools operating in constrained workflows under clinician oversight** — see [[ambient-ai-scribes]] and [[clinical-validation]]. Sepsis prediction has a:
...
This is why the evidence base is stronger here than for open-ended diagnostic LLMs — see [[ai-hallucination-medical]].
...
## Related
- [[clinical-validation]] — TREWS is a positive example of real-world evidence.
- [[ambient-ai-scribes]] — the other narrow-tool exemplar.
- [[fda-510k-pathway]] — relevant if/when TREWS pursues device clearance.
- [[ai-index-2026]] — primary source.

## Sources
- [[ai-index-2026]] (Ch. 6.2 Enterprise-Scale Deployments — AI-Powered Sepsis Prediction, p. 277)
