...
- Tested against **NEJM-derived cases**, which are **case-style cognitive evaluations**, not real-world clinical settings — see [clinical-validation](../concepts/clinical-validation.md).
...
- More deployment-realistic benchmarks (MedAgentBench, 300 EHR-derived tasks) show the best AI agents top out at **69.7%** — see [agentic-clinical-ai](../concepts/agentic-clinical-ai.md).
...
## Sources
- [ai-index-2026](../sources/ai-index-2026.md) (Ch. 6.2, p. 272–273)
